...
class ClassesIntentionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('intention_classes')->insert([ 
            ['id'=>1,'classe'=>'7º dia','typeintention'=>1,'print_position'=>1,'empty_lines'=>0,'created_at'=>date('Y-m-d H:i:s',time())],
            ['id'=>2,'classe'=>'30º dia','typeintention'=>1,'print_position'=>2,'empty_lines'=>0,'created_at'=>date('Y-m-d H:i:s',time())],
            ...
            ['id'=>5,'classe'=>'Pelo aniversário','typeintention'=>2,'print_position'=>5,'empty_lines'=>0,'created_at'=>date('Y-m-d H:i:s',time())],             
